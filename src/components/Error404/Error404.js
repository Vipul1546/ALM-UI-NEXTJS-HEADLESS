...
const Error404 = () => {
    return (
        <div className={styles["Error404"]}>
            <svg id="404-Dave" className={styles["Error404_svg"]} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 250">
                <defs>
                    <clipPath id="center-circle-clip"><circle cx="275.667" cy="122.667" r="84.33" />
                    </clipPath>
                </defs>
                <g id="bg">
                    <path id="Bg-green" fill="#f91101" d="M275.7 207c-46.5 0-84.3-37.8-84.3-84.3s37.8-84.3 84.3-84.3S360 76.2 360 122.7 322.2 207 275.7 207z" />
                ...
                <g id="Dave-clipper" clip-path="url(#center-circle-clip)">
                    <g id="Dave">
                        ...
                        <g id="Eyes" fill="#263D52">
                            <circle id="eyes-left" style={{ transformOrigin: '256.4px 114.3px;' }} className={styles["blinking-eyes"]} cx="256.4" cy="114.3" r="5.9" />
                            <circle id="eyes-right" style={{ transformOrigin: '294.3px 114.3px;' }} className={styles["blinking-eyes"]} cx="294.3" cy="114.3" r="5.9" />
                        </g>
            ...
            <Link href="/" className={styles["Error404_cta"]}>Home</Link>
        </div>
